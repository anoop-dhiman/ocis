...
func StorageProviderDrivers(cfg *config.Config) map[string]interface{} {
	return map[string]interface{}{
		...
		"ocis_encrypted": OcisEncrypted(cfg, OcisNoEvents(cfg)),
		"s3ng_encrypted": S3NGEncrypted(cfg, S3NGNoEvents(cfg)),
	}
}
...
func DataProviderDrivers(cfg *config.Config) map[string]interface{} {
	return map[string]interface{}{
		...
		"ocis_encrypted": OcisEncrypted(cfg, Ocis(cfg)),
		"s3ng_encrypted": S3NGEncrypted(cfg, S3NG(cfg)),
	}
}
